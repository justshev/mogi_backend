...
//     apiKey: "AIzaSyDkGm4hOAmaCoePDX5mBc5dECdBMUSN5vk", // ganti dengan env untuk keamanan
//   });
...
//     systemInstruction: [
//       {
//         text: "Kamu adalah AI analis lingkungan. Tugasmu adalah membaca data suhu dan kelembapan, lalu merespons dalam format JSON. Jawaban HARUS hanya berupa JSON dan valid untuk di-parse dengan JSON.parse.",
//       },
//     ],
//   };
...
//   let inputText = "Berikut adalah kumpulan data suhu dan kelembapan:\n\n";
//   logs.forEach((log, index) => {
//     inputText += `Data ${index + 1}: Suhu ${log.temperature}°C, Kelembapan ${
//       log.humidity
//     }%\n`;
//   });
...
const genAI = new GoogleGenAI({
  apiKey: "", // Ganti dengan API Key yang aman di production
});
